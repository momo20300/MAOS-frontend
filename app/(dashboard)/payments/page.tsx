    ...
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card className="rounded-2xl">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-600">{received.toLocaleString()} MAD</div>
          </CardContent>
        </Card>
        <Card className="rounded-2xl">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-red-600">{paid.toLocaleString()} MAD</div>
          </CardContent>
        </Card>
      </div>
          ...
          <div className="space-y-3">
            {filteredPayments.map((payment) => (
              ...
              >
                ...
                <div className={`text-lg font-bold ${payment.payment_type === 'Receive' ? 'text-green-600' : 'text-red-600'}`}>
